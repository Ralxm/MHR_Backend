...
router.get('/listAceites', controller.candidaturasListAceites);
router.get('/listEmAnalise', controller.candidaturasListAnalise);
router.get('/listRejeitadas', controller.candidaturasListRejeitadas);
